...
каскада к существующим группам реализованы и локально приняты.
Следующий кодовый срез - 61C, версии будущего состава и единая
материализация индивидуальных/групповых серий.
...
1. Реализовать 61C: версии только будущего состава и единый сервис
   материализации индивидуальных/групповых серий без изменения фактов прошлого.

...
Дата контрольной точки: 2026-09-08
...
1. Следующий срез после принятого реестра 61D-2 — редактор будущего состава с сохранением
   существующих занятий и истории редакций. Затем отдельно — безопасный UI
   stop/resume с обязательным hardening из 61D-1, переходы программы/каскада,

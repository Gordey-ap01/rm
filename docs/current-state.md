...
грантового отчета завершены. Следующий доменный этап — безопасный жизненный
цикл грантового плана; параллельно нужны решения по внешней эксплуатации.
...
2. Спроектировать отдельным опасным срезом append-only версии грантового плана
   и распределений, ledger-backed выделение получателю, фиксированную оплату
   проекта и снимок закрытого донорского отчета. Модели и migration chain
   остаются у одного DB owner.

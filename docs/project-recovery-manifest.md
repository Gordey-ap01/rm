...
- Recovery priority now: continue from the chain UX/operations layer. Before adding a separate manager dashboard, compare it against the new dashboard/work queue signals; do not add migrations or touch ledger/payroll unless a fresh contract is approved.

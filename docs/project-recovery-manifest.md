...
| `docs/61-group-program-series-lifecycle-contract.md` | Активный доменный контракт: 61A-61B, 61C-1/61C-2/61C-3, `0060-0063`, `missing_only`, `retry_skipped`, stop/resume и cancel реализованы; следующее withdraw и 61D UI. |

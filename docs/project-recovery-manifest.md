...
| `docs/61-group-program-series-lifecycle-contract.md` | Активный доменный контракт: 61A-61B и 61C-1/61C-2/61C-3 реализованы; `0060` expand для 61C-4a принят локально, следующие missing/retry/cancel и 61D. |

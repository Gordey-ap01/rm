...
| `docs/61-group-program-series-lifecycle-contract.md` | Активный доменный контракт: 61A-61B, 61C-1/61C-2/61C-3, `0060`, `missing_only` и frozen retry targets `0061`; следующее исполнение retry, затем cancel и 61D. |

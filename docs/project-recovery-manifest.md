...
| `docs/61-group-program-series-lifecycle-contract.md` | Активный доменный контракт: 61A-61B, 61C-1/61C-2/61C-3, `0060` expand и `missing_only` 61C-4a приняты локально; следующие retry/cancel и 61D. |
